...
public class SaleServiceTest {
    ...
    public void testAddSale_ValidCustomer_AddsSuccessfully() throws ApplicationException {
        ...
        CustomerDTO mockCustomer = new CustomerDTO(1, 241364817, "Mock Customer", 966666666);
...
- During testing, a fault was discovered in the database schema design that manifested as a failure in referential integrity. Specifically:
    ...
    3. Propagation: The infected state propagates to application failures when:
        ...
        - Database constraints are violated on subsequent operations
